...
class BoardAdapter extends RecyclerView.Adapter<BoardAdapter.BoardViewHolder> {
    ...
    public BoardAdapter(BoardFragment boardFragment, ArrayList<MessageItem> InData) {
...
//        private int i=0;
    ...
    public BoardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(boardFragment.getActivity()).inflate(R.layout.item_message, null, false);
    ...
    public void onBindViewHolder(@NonNull BoardViewHolder holder, int position) {
        ...
        Drawable photo = boardFragment.getResources().getDrawable(messageItem.getmPhoto());
    ...
    private BoardAdapter.OnButtonClickListener onButtonClickListener;

    public void setOnButtonClickListener(BoardAdapter.OnButtonClickListener onButtonClickListener) {
